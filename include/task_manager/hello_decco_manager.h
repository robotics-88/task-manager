...
class HelloDeccoManager {
  public:
    ...
    std_msgs::msg::String acceptFlight(json msgJson, geometry_msgs::msg::Polygon &polygon,
                                       bool &poly_valid, double &home_elevation,
                                       const rclcpp::Time timestamp, bool &has_elevation);
    ...
    std_msgs::msg::String packageToTymbalHD(std::string topic, json gossip,
                                            const rclcpp::Time timestamp);
    ...
    bool polygonToGeofence(const geometry_msgs::msg::Polygon &polygon,
                           std::shared_ptr<mavros_msgs::srv::WaypointPush::Request> &req,
                           const geometry_msgs::msg::PoseStamped drone_position);

    geometry_msgs::msg::Polygon getMapPolygon() { return map_region_; }
  ...
  private:
    ...
    enum FlightStatus { NOT_STARTED, ACTIVE, COMPLETED };
